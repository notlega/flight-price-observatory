...
Details: [architecture](architecture.md), [design](design.md), [data model](data-model.md).
...
| Gold layer — route profiles, lead curves, forward curve, spike warnings | [@josephyqf](https://github.com/josephyqf) | [runbook](gold_layer.md) |
